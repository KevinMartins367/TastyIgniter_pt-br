...
$theme['customize']['sections']['general'] = array(
	...
	'fields'		=> array(
		array(
			...
			'type' 		=> 'button-group',
			'group'			=> array(
				array('data-btn' => 'btn-default', 'name' => 'display_crumbs', 'type' => 'radio', 'label' => 'Sim', 'value' => '1', 'checked' => TRUE),
				array('data-btn' => 'btn-default', 'name' => 'display_crumbs', 'type' => 'radio', 'label' => 'Não', 'value' => '0', 'rules' => 'required|numeric'),
			)
		),
		array(
			'id'		=> 'input-hide-admin-link',
			'name'		=> 'hide_admin_link',
			'label' 	=> 'Ocultar o link admin do rodapé',
			'type' 		=> 'button-group',
			'group'			=> array(
				array('data-btn' => 'btn-default', 'name' => 'hide_admin_link', 'type' => 'radio', 'label' => 'Sim', 'value' => '1'),
				array('data-btn' => 'btn-default', 'name' => 'hide_admin_link', 'type' => 'radio', 'label' => 'Não', 'value' => '0', 'checked' => TRUE, 'rules' => 'required|numeric'),
			)
		),
		array(
			'id'        => 'input-ga-tracking-code',
			'name'      => 'ga_tracking_code',
			'label'     => 'Código de acompanhamento Google Analytics',
			'desc'      => 'Cole o seu código de acompanhamento do Google Analytics aqui.',
			'type'      => 'textarea',
			'rows'      => '10',
			'value'     => ''
		),
...
$theme['customize']['sections']['typography'] = array(
	...
	'fieldset'	=> array(
		array(
			'legend'		=> 'Corpo Principal',
			'fields'	=> array(
				array(
					'id'			=> 'input-font-family',
					'name'			=> 'font[family]',
					'label' 		=> 'Font Family',
					'desc'			=> 'A família de fontes para usar para o texto do corpo principal.',
					'type' 			=> 'text',
				...
				array(
					...
					'desc'			=> 'O peso e estilo da fonte para usar para o texto do corpo principal.',
					'type' 			=> 'input-group',
					'group'			=> array(
				...
				array(
					...
					'desc'			=> 'O tamanho da fonte e a cor para usar no texto do corpo principal.',
					'type' 			=> 'input-group',
					'group'			=> array(
		...
		array(
			'legend'		=> 'Menu de Cabeçalho',
			'fields'	=> array(
				array(
					'id'			=> 'input-menu-font-family',
					'name'			=> 'menu_font[family]',
					'label' 		=> 'Header menu font family',
					'desc'			=> 'A família de fontes para usar no menu de cabeçalho.',
					'type' 			=> 'text',
					'value'			=> '"Oxygen",Arial,sans-serif',
		            'rules'         => 'required',
				),
				array(
					...
					'desc'			=> 'O peso ea estilo da fonte para usar no menu do cabeçalho.',
					'type' 			=> 'input-group',
					'group'			=> array(
				...
				array(
					...
					'desc'			=> 'O tamanho da fonte e a cor para usar no menu do cabeçalho.',
					'type' 			=> 'input-group',
					'group'			=> array(
