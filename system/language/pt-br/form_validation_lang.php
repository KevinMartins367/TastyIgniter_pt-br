...
$lang['form_validation_min_length']		= 'O campo {field} deve ter pelo menos {param} caracteres em comprimento.';
$lang['form_validation_max_length']		= 'O campo {field} não pode exceder os caracteres {param} em comprimento.';
$lang['form_validation_exact_length']		= 'O campo {field} deve ser exatamente caracteres {param} em comprimento.';
...
$lang['form_validation_alpha_numeric_spaces']	= 'O campo {field} só pode conter caracteres e espaços alfanuméricos.';
$lang['form_validation_alpha_dash']		= 'O campo {field} pode conter apenas caracteres alfa-numéricos, sublinhados e traços.';
...
$lang['form_validation_is_natural_no_zero']	= 'O campo {field} deve conter apenas dígitos e deve ser maior do que zero.';
$lang['form_validation_decimal']		= 'O campo {field} deve conter um número decimal.';
$lang['form_validation_less_than']		= 'O campo {field} deve conter um número inferior a {param}.';
$lang['form_validation_less_than_equal_to']	= 'O campo {field} deve conter um número menor ou igual a {param}.';
$lang['form_validation_greater_than']		= 'O campo {field} deve conter um número maior do que {param}.';
$lang['form_validation_greater_than_equal_to']	= 'O campo {field} deve conter um número maior ou igual a {param}.';
$lang['form_validation_error_message_not_set']	= 'Não é possível acessar uma mensagem de erro correspondente ao seu nome de campo {field}.';
