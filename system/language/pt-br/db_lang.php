...
61/5000
As atualizações não são permitidas a menos que elas contenham uma cláusula "where".';
...
$lang['db_unable_to_drop'] = 'Não é possível soltar o banco de dados especificado.';
...
$lang['db_invalid_cache_path'] = 'O caminho do cache que você enviou não é válido ou pode ser gravado.';
