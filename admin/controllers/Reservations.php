...
class Reservations extends Admin_Controller {
	...
	public function index() {
		...
		if ($this->input->get('show_calendar') === '1') {
			...
			$data['months'] = array('01' => 'Janeiro', '02' => 'Fevereiro', '03' => 'Março', '04' => 'Abril', '05' => 'Maio', '06' => 'Junho', '07' => 'Julho', '08' => 'Agosto', '09' => 'Setembro', '10' => 'Outubro', '11' => 'Novembro', '12' => 'Dezembro');
			$data['years'] = array('2013', '2014', '2015', '2016', '2017', '2018', '2019' );
			...
			for ($i = 1; $i <= $data['days']; $i++) {
				$date = $year . '-' . $month . '-' . $i;
				$reserve_date = mdate('%d-%m-%Y', strtotime($date));
