...
$(document).ready(function() {
    moment.locale('pt-br');
    $('button.daterange span').html(moment().subtract(29, 'days').format('D, MM YYYY') + ' - ' + moment().format('D, MM YYYY'));
    ...
    $('button.daterange').daterangepicker({
        ...
        $('button.daterange span').html(start.format('D, MM YYYY') + ' - ' + end.format('D, MM YYYY'));
    });
...
var myAreaChart = Morris.Area({
    ...
    labels: ['Total de Clientes', 'Total de Pedidos', 'Total de Reservas', 'Total de Comentários'],
